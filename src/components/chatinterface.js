...
export default function ChatInterface({ chatHistory, onChatResponse, hasDocuments }) {
      ...
      {hasDocuments && (
        <div className="px-4 sm:px-0 pb-2">
          <form onSubmit={handleSubmit} className="relative">
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-slate-800/80 via-slate-700/80 to-slate-800/80 backdrop-blur-2xl border border-white/20 rounded-full shadow-2xl max-h-14 sm:max-h-16">
              ...
              <div className="relative flex items-end space-x-2 sm:space-x-3 p-2 sm:p-3">
                <div className="flex-1 relative">
                  ...
                  {!inputMessage && (
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none text-sm sm:text-base flex items-center space-x-2">
                      <span className="animate-pulse">💬</span>
                      <span>Ask me anything about your insurance documents...</span>
                    </div>
                  )}
  ...
  placeholder=""
  className="w-full bg-transparent text-white border-none outline-none resize-none text-sm sm:text-lg leading-relaxed font-medium rounded-full px-4 py-2"
  rows="1"
  disabled={isLoading}
  maxLength={1000}
  style={{
...
//           <form onSubmit={handleSubmit} className="relative">
//             <div className="flex items-end space-x-2 sm:space-x-4 p-4 sm:p-6 bg-slate-800 bg-opacity-60 backdrop-blur-xl border border-white border-opacity-10 rounded-3xl">
//               <div className="flex-1">
//                 <textarea
//                   ref={inputRef}
//                   value={inputMessage}
...
//                   className="w-full bg-transparent text-white placeholder-gray-400 border-none outline-none resize-none text-sm sm:text-lg leading-relaxed"
//                   rows="1"
//                   disabled={isLoading}
//                   style={{
//                     minHeight: '20px',
...
//                 type="submit"
//                 disabled={!inputMessage.trim() || isLoading}
//                 className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-lg sm:text-xl shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
//               >
//                 {isLoading ? (
...
//             {/* Input Hint */}
//             <div className="flex justify-between items-center mt-2 sm:mt-3 px-2 text-xs sm:text-sm">
